...
function displayCart() {
    ...
    if (cart.length === 0) {
        cartItems.innerHTML = '<div class="empty-cart"><p>Your cart is empty. <a href="products.html">Start shopping</a></p></div>';
...
function performSearchRedirect() {
    ...
    if (query) {
        ...
        window.location.href = 'products.html'; // Redirect to products page without filter if empty
    }
}
